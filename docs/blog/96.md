...
15  main 5432 down   postgres /data/postgresql/15/main      /var/log/postgresql/postgresql-15-main.log
```

### PostgreSQL Clusters 초기화

```bash
su - postgres -c '/usr/lib/postgresql/15/bin/initdb --locale=ko_KR.UTF-8 -D /data/postgresql/15/main'
```
