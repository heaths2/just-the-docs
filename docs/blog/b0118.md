...
sudo ip route add 192.168.0.0/24 dev eth1 src 192.168.0.35 table 101
sudo ip rule add from 192.168.0.35/24 table 101
sudo ip rule add to 192.168.0.35/24 table 101
```
