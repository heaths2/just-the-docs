...
- [AWX Operator 태그 참고](https://github.com/ansible/awx-operator/tags)
- [K3s 공식 문서](https://github.com/k3s-io/k3s)
- [Kustomize 공식 문서](https://kubectl.docs.kubernetes.io/installation/kustomize/binaries/)
- [Minikube 공식 문서](https://docs.docker.com/engine/install/ubuntu/)(https://docs.docker.com/engine/install/linux-postinstall/)
