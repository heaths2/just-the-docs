...
qr_url=$(echo '-1' | su $user sh -c "google-authenticator -tdf -r 1 -Q UTF8 -w 3 -R 30 -s /home/$user/google_authenticator" | grep -o 'https://www.google.com/chart?chs=200x200&chld=M|0&cht=qr&chl=.*')
