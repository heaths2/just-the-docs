...
chroot ${prefix} /bin/bash -c "localectl set-locale LANG=en_US.UTF-8"
chroot ${prefix} /bin/bash -c "sed -i 's/# ko_KR.UTF-8 UTF-8/ko_KR.UTF-8 UTF-8/' /etc/locale.gen && locale-gen"
...
chroot ${prefix} /bin/bash -c "systemctl disable --now systemd-networkd-wait-online.service"
