...
:dhcperror
prompt --key s --timeout 10000 DHCP ${fg_red}failed${fg_off}, Hit the ${bold}${fg_gre}s${fg_off}${boldoff} key to open iPXE shell && shell || reboot

:netboot
chain tftp://${next-server}/main.ipxe ||
prompt --key s --timeout 10000 Chainloading ${fg_red}failed${fg_off}, Hit the ${bold}${fg_gre}s${fg_off}${boldoff} key to open iPXE shell && shell || reboot
```
