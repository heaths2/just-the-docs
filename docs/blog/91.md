...
>
>
![image](https://github.com/heaths2/heaths2.github.io/assets/36792594/654ac6c7-8b76-4be7-9760-481aafa1714f)
>
>
```bash
\c awx
...
>
>
![image](https://github.com/heaths2/heaths2.github.io/assets/36792594/b809f560-66ec-46bb-8bf5-d8161cc4b1c9)
>
>
>
> - [Tag 버전](https://github.com/ansible/awx-operator/releases) 2.4.0 기준 호스트 목록 DB 추가 Query
```sql
INSERT INTO main_host (created, modified, description, name, enabled, instance_id, variables, created_by_id, inventory_id, modified_by_id, ansible_facts)
VALUES
  (current_timestamp, current_timestamp, '', '192.168.0.1', true, '', '---', '1', 1, '1', '{}'),
  (current_timestamp, current_timestamp, '', '192.168.0.2', true, '', '---', '1', 1, '1', '{}');
```
>
> - `awx` 계정 패스워드 변경 방법
```bash
